    ...
    <el-dialog style="border-radius: 5px !important;" :title="props.itemEdit ? 'Cập nhật dãy' : 'Tạo mới dãy'" width="700">
      <el-row :gutter="20">
        <el-col :span="12">
          ...
          <el-input :disabled="props.itemEdit" v-model="MaDay" size="large" style="width: 100%" placeholder="Nhập mã dãy" />
        ...
        <el-col class="mt-4" :span="12">
          ...
          <el-input v-model="name" size="large" style="width: 100%" placeholder="Nhập tên dãy" />
        ...
        <el-col class="mt-4" :span="12">
          <p>Mô tả</p>
          <el-input v-model="MoTa" type="textarea" :rows="4" size="large" style="width: 100%" placeholder="Nhập mô tả" />
