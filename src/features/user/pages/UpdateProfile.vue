<template>
    <el-dialog style="border-radius: 5px !important" :title="props.itemEdit ? 'Cập nhật thông tin hồ sơ' : 'Chưa có ID'"
        ...
        <el-row :gutter="20">
            ...
            <el-col class="mt-4" :span="12">
                <p>Ngày sinh</p>
                <el-date-picker v-model="Birthday" style="width: 100%" type="date"
            ...
            <el-col class="mt-4" :span="12">
                ...
                <el-select disabled v-model="RoleId" class="w-full" size="large" clearable collapse-tags
                    placeholder="Chọn vai trò" popper-class="custom-header" :max-collapse-tags="1">
...
import { MESSAGE_ERROR, PageName, Regex } from "../../../common/contants/contants";
