<template>
  ...
  <div class="flex mt-5">
    ...
    <div class="w-4/12 flex justify-end">
      <el-button @click="{ showDialog = true; idEdit = null }" type="primary" size="large">
          ...
          <div class="flex flex-col">
            ...
            <div class="mt-1">
              <el-button @mouseover="showContentPassword = true" @mouseleave="showContentPassword = false"
                class="w-[5px] h-[5px] relative" @click="resetPassword(user.id)" size="small" plain>
                <i class="ri-lock-line"></i>
              </el-button>
              <span v-if="showContentPassword" class="button-password w-[120px] text-xs"
            ...
            <div class="mt-1">
              <el-tooltip class="box-item" effect="dark" content="Xóa" placement="top">
                <el-button class="w-[5px] h-[5px]" size="small" plain @click="
                    {
                  idDelete = user.id;
...
async function resetPassword(id: string) {
  const res = await userServiceApi.resetPassword(id as string);
  if (res.success) {
    showSuccessNotification(res.message)
  }
  else {
