<template>
    ...
    <div class="custom-table mt-10">
        <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1 gap-4">
            <div v-for="i in 10" :key="i" class="hover-border-red lg:w-3/9 min-h-[200px] rounded-md flex flex-col items-center border border-neutral-300 hover:cursor-pointer relative">
                <div class="mt-5 relative">
                    <el-avatar style="width: 60px;height: 60px;" src="https://scontent.fhan14-5.fna.fbcdn.net/v/t39.30808-6/431664450_3808572406136738_6223671059774018184_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=5f2048&_nc_ohc=ZW_6ILBTsHAAX83Fn-q&_nc_ht=scontent.fhan14-5.fna&oh=00_AfCwKJRrLGIuWzCy7GOqwGt6Dd3Dcjr8w-MA2kxU5m1eZw&oe=66059010"/>
