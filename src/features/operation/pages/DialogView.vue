<template>
    <el-dialog style="border-radius: 5px !important;" :title="props.itemEdit ? 'Cập nhật thao tác' : 'Tạo mới thao tác'"
        width="500">
        <el-row :gutter="20">
            <el-col :span="24">
                <p>Tên thao tác
                ...
                <el-input v-model="name" size="large" style="width: 100%" placeholder="Nhập tên thao tác" />
            ...
            <el-col class="mt-4" :span="24">
                ...
                <el-input v-model="url" size="large" style="width: 100%" placeholder="Nhập đường dẫn" />
