<template>
    <el-dialog align-center style="border-radius: 5px !important;"
        :title="props.itemEdit ? 'Cập nhật kệ' : 'Tạo mới kệ'" width="700">
        <el-row :gutter="20">
            <el-col :span="12">
                <p>Mã hộp
                    <span class="text-red-500">*</span>
                </p>
                <el-input :disabled="props.itemEdit" v-model="MaHop" size="large" style="width: 100%"
            ...
            <el-col :span="12">
                ...
                <el-input v-model="name" size="large" style="width: 100%" placeholder="Nhập tên hộp" />
