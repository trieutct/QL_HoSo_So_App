<template>
  <el-menu
    class="w-[380px] min-h-screen font-semibold relative"
  ...
  >
    ...
    <div
      class="w-[80%] m-4 text-white text-3xl flex justify-center"
    ...
    <div class="overflow-y-auto h-[calc(100vh-20%)] scrollbar-none">
      ...
      >
        ...
        <div class="flex justify-around">
          <div
            v-if="!isCollapse"
            class="w-[3px] bg-white ml-6 rounded-s-md"
          ></div>
          <div :class="!isCollapse ? 'w-[80%] mr-2' : 'w-full'">
            <el-menu-item
              v-for="i in item.operations"
              :key="i.id"
              @click="routerURL(i.url)"
              :class="
                !isCollapse
      ...
      <div
        class="w-full bottom-0 h-[100px] absolute flex justify-around"
      ...
      >
        ...
        <div class="relative flex justify-center items-center">
          <div v-if="!isCollapse">
            <i
              class="ri-more-2-line text-lg text-white cursor-pointer"
              @click="showMenuUser = !showMenuUser"
            ></i>
          </div>
          <div
          ...
          >
            <p class="block hover:bg-blue-hover px-4 py-2">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item
                    ...
                    @click="onChangeLanguage(item.value)"
                    :key="item"
                    class="px-4 py-2"
                    ><img width="25" height="25" :src="item.img" />
