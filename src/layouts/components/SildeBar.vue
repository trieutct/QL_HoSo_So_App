    ...
    <div class="overflow-y-auto h-[calc(100vh-20%)] scrollbar-none">
      ...
      <el-sub-menu v-for="(item, index) in modules" :key="index" :index="index + 1">
        <template #title>
          ...
          <span class="font-light ml-2" v-if="!isCollapse">{{ item.name }}</span>
        </template>
      ...
      <div class="w-full bottom-0 h-[100px] absolute flex justify-around" style="background-color: rgb(83, 109, 193,1)">
