<template>
  ...
  >
    ...
    <div class="overflow-y-auto h-[calc(100vh-20%)] scrollbar-none">
      <el-menu-item
        v-if="localStorageAuthService.getLoginUser().role === Role.SYSADMIN"
        index="1"
        @click="routerURL('/admin/dashboard')"
      >
        <el-icon>
      ...
      >
        <div class="flex justify-center items-center">
          <div>
            <img
              ...
              class="radius cursor-pointer"
              width="60"
              height="60"
              :src="localStorageAuthService.getLoginUser().avatar"
              alt=""
            />
          </div>
        ...
        <div class="relative flex justify-center items-center">
          ...
          >
            ...
            <p
              class="block hover:bg-blue-hover px-4 py-2 cursor-pointer"
              @click="logOut"
            >
