<template>
  <el-menu class="w-[380px] min-h-screen font-semibold relative" background-color="#4764c3"
    ...
    <div class="overflow-y-auto h-[calc(100vh-20%)] scrollbar-none">
      <el-menu-item v-if="localStorageAuthService.getLoginUser().role === Role.SYSADMIN" index="1"
      ...
      <div class="w-full bottom-0 h-[100px] absolute flex justify-around"
        ...
        <div class="flex justify-center items-center">
          <div>
            <img @click="showMenuUser = !showMenuUser" class="radius cursor-pointer" width="60" height="60"
        ...
        <div class="relative flex justify-center items-center">
          ...
          <div v-if="showMenuUser"
            ...
            <router-link
              :to="{ name: PageName.USERDETAIL_PAGE, params: { id: localStorageAuthService.getLoginUser().id } }">
              <p class="block hover:bg-blue-hover px-4 py-2 cursor-pointer">
                <i class="ri-user-line mr-2"></i>Hồ sơ của tôi
              </p>
            </router-link>

            <router-link :to="{ name: PageName.CHANGEPASSWORD_PAGE }">
              <p class="block hover:bg-blue-hover px-4 py-2 cursor-pointer">
