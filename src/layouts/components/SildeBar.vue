        ...
        <div class="overflow-y-auto h-[calc(100vh-20%)] scrollbar-none">
          <el-sub-menu index="1">
            <template #title>
              ...
              <span class="font-light ml-2" v-if="!isCollapse">Quản lý hệ thống</span>
            </template>
            <div class="flex justify-around">
              <div v-if="!isCollapse" class="w-[3px] bg-white ml-6 rounded-s-md"></div>
              <div :class="!isCollapse ? 'w-[80%] mr-2' : 'w-full'">
                <el-menu-item @click="routerURL('user_page')" :class="!isCollapse ? 'rounded-md font-normal' : 'rounded-none font-normal'"
                  style="height: 40px;" index="1-4-1">Quản lý người dùng</el-menu-item>
                <el-menu-item @click="routerURL('kho_page')" :class="!isCollapse ? 'rounded-md font-normal' : 'rounded-none font-normal'"
                  style="height: 40px;" index="1-4-2">Quản lý kho</el-menu-item>
                <el-menu-item @click="routerURL('day_page')" :class="!isCollapse ? 'rounded-md font-normal' : 'rounded-none font-normal'"
                  style="height: 40px;" index="1-4-3">Quản lý dãy</el-menu-item>
                <el-menu-item @click="routerURL('ke_page')" :class="!isCollapse ? 'rounded-md font-normal' : 'rounded-none font-normal'"
                  style="height: 40px;" index="1-4-4">Quản lý kệ</el-menu-item>
              </div>
            </div>
          </el-sub-menu>
            ...
            <div class="flex justify-center items-center">
              <div>
                <img @click="showMenuUser=!showMenuUser" class="rounded-full cursor-pointer" width="60" height="60"
                  src="https://scontent.fhan5-2.fna.fbcdn.net/v/t39.30808-6/431664450_3808572406136738_6223671059774018184_n.jpg?_nc_cat=104&ccb=1-7&_nc_sid=5f2048&_nc_ohc=_D4EcMtMV1QAX-CBl8p&_nc_ht=scontent.fhan5-2.fna&oh=00_AfAjbKOVdlDMAbx4pWLItv7sPbunH9NIKgl1sjegnN6Krg&oe=66113550"
                  alt="">
              </div>
